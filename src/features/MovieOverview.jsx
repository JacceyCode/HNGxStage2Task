...
function MovieOverview() {
  ...
  return (
    <section className="flex flex-col">
      <section className="flex flex-wrap items-center justify-between gap-2 font-['Poppins'] text-xl font-medium text-neutral-700">
        <span className="flex flex-wrap gap-2">
          <span data-testid="movie-title">{"SPIDDER-MAN"}</span>
          <span>&middot;</span>
      ...
      <section className="flex flex-wrap gap-4 md:flex-nowrap">
        ...
        >
          ...
          <p className="font-['Poppins'] text-xl font-normal text-zinc-800">
            {
              "OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW OVERVIEW"
            }
          </p>
          <p className="font-['Poppins'] font-normal text-zinc-600">
            Production company :{" "}
